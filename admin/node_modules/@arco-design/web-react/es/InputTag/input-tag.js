...
function InputTag(baseProps, ref) {
    ...
    var childrenTagWithAnimation = useMemo(function () {
        var items = value.map(function (x, i) {
            ...
            return React.isValidElement(eleTag) ? (React.createElement(CSSTransition, { key: isRepeat ? valueKey + "-" + i : valueKey, timeout: CSS_TRANSITION_DURATION, classNames: "zoomIn" }, eleTag)) : (eleTag);
        });
        return items;
    }, [value]);
    var suffixInput = [
        React.createElement(CSSTransition, { key: REACT_KEY_FOR_INPUT, timeout: CSS_TRANSITION_DURATION, classNames: "zoomIn" },

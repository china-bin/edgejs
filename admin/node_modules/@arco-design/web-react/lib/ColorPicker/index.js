...
function ColorPicker(baseProps, ref) {
    ...
    var renderPanel = function () {
        return (react_1.default.createElement(panel_1.Panel, { color: color, alpha: alpha, colorString: colorString, historyColors: historyColors, presetColors: presetColors, showHistory: showHistory, showPreset: showPreset, onHsvChange: onHsvChange, onAlphaChange: onAlphaChange, disabledAlpha: disabledAlpha, renderFooter: renderFooter }));
    };

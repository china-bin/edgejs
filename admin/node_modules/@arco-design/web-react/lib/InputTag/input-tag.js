...
function InputTag(baseProps, ref) {
    ...
    function renderEllipsisNode(invisibleTagCount) {
        var renderEllipsisLabel = typeof maxTagCount === 'object' && maxTagCount.render
            ...
            : function () { return react_1.default.createElement("span", { className: prefixCls + "-tag-ellipsis" },
                "+",
                invisibleTagCount); };
        return (react_1.default.createElement(Popover_1.default, __assign({}, ((0, is_1.isObject)(maxTagCount) ? maxTagCount.popoverProps : {}), { children: renderEllipsisLabel(invisibleTagCount, value), content: react_1.default.createElement(react_1.default.Fragment, null, value
    ...
    var childrenTagWithAnimation = (0, react_1.useMemo)(function () {
        var items = value.map(function (x, i) {
            ...
            return react_1.default.isValidElement(eleTag) ? (react_1.default.createElement(react_transition_group_1.CSSTransition, { key: isRepeat ? valueKey + "-" + i : valueKey, timeout: CSS_TRANSITION_DURATION, classNames: "zoomIn" }, eleTag)) : (eleTag);
        });
        return items;
    }, [value]);
    var suffixInput = [
        react_1.default.createElement(react_transition_group_1.CSSTransition, { key: REACT_KEY_FOR_INPUT, timeout: CSS_TRANSITION_DURATION, classNames: "zoomIn" },
        ...
        react_1.default.createElement("div", { className: prefixCls + "-view" },
            ...
            draggable ? (react_1.default.createElement(UsedTransitionGroup, { key: "transitionGroupWithDrag", prefixCls: prefixCls, animation: animation },
                react_1.default.createElement(Draggable_1.default, { itemWrapperStyle: { display: 'inline-block' }, direction: "horizontal", onIndexChange: function (index, prevIndex) {
                    ...
                    } }, childrenTagWithAnimation.concat(suffixInput)))) : (react_1.default.createElement(UsedTransitionGroup, { prefixCls: prefixCls, animation: animation }, maxTagCountValue === MAX_TAG_RESPONSIVE ? (react_1.default.createElement(OverflowEllipsis_1.default, { items: childrenTagWithAnimation, suffixItems: suffixInput, ellipsisNode: function (_a) {

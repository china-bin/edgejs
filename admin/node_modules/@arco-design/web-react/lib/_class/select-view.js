...
var CoreSelectView = react_1.default.forwardRef(function (props, ref) {
    ...
    var renderMultiple = function () {
        ...
        var maxTagCountRender = function (invisibleCount) {
            return (react_1.default.createElement(Tag_1.default, { className: (0, classNames_1.default)(getPrefixCls('input-tag') + "-tag", prefixCls + "-tag") }, (0, is_1.isObject)(maxTagCount) && (0, is_1.isFunction)(maxTagCount.render)
        ...
        return (react_1.default.createElement(InputTag_1.default, __assign({}, inputPropsOverrideConfigProvider, { 
            ...
            className: mergedFocused ? getPrefixCls('input-tag') + "-focus" : '', ref: refInput, disabled: disabled, dragToSort: dragToSort, disableInput: !showSearch, animation: animation, placeholder: placeholder, value: tagsToShow, inputValue: inputValue, size: mergedSize, tagClassName: prefixCls + "-tag", renderTag: renderTag, icon: { removeIcon: removeIcon }, maxTagCount: maxTagCount
                ? {
                    count: (0, is_1.isObject)(maxTagCount) ? maxTagCount.count : maxTagCount,
                    render: maxTagCountRender,
                    popoverProps: { disabled: true },
                }
                : undefined, onChange: function (newValue, reason) {

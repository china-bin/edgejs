...
} from "./chunk-DQQ2BI2D.js";
import {
  require_baseClone,
  require_isPlainObject
} from "./chunk-2BYBTI55.js";
import {
  require_arrayMap,
  require_baseGetTag,
  require_identity,
...
} from "./chunk-ODRAJB7E.js";
import {
  require_prop_types
} from "./chunk-MCE6COP4.js";
import "./chunk-HONV43VG.js";
import {
  require_react
} from "./chunk-7T7DSFPE.js";
import {
  __commonJS,
  __toModule
} from "./chunk-M4FGWWHG.js";
...
var require_tinycolor = __commonJS({
  "node_modules/tinycolor2/tinycolor.js"(exports2, module2) {
    (function(Math2) {
      ...
      function tinycolor2(color10, opts) {
        color10 = color10 ? color10 : "";
        opts = opts || {};
        if (color10 instanceof tinycolor2) {
          return color10;
        }
        if (!(this instanceof tinycolor2)) {
          return new tinycolor2(color10, opts);
        }
        var rgb = inputToRGB(color10);
        this._originalInput = color10, this._r = rgb.r, this._g = rgb.g, this._b = rgb.b, this._a = rgb.a, this._roundA = mathRound(100 * this._a) / 100, this._format = opts.format || rgb.format;
      ...
      tinycolor2.prototype = {
        ...
        _applyModification: function(fn, args) {
          var color10 = fn.apply(null, [this].concat([].slice.call(args)));
          this._r = color10._r;
          this._g = color10._g;
          this._b = color10._b;
          this.setAlpha(color10._a);
          return this;
        },
        lighten: function() {
      ...
      tinycolor2.fromRatio = function(color10, opts) {
        if (typeof color10 == "object") {
          var newColor = {};
          for (var i in color10) {
            if (color10.hasOwnProperty(i)) {
              if (i === "a") {
                newColor[i] = color10[i];
              } else {
                newColor[i] = convertToPercentage(color10[i]);
              }
            }
          }
          color10 = newColor;
        }
        return tinycolor2(color10, opts);
      };
      function inputToRGB(color10) {
        var rgb = { r: 0, g: 0, b: 0 };
        var a = 1;
        var s = null;
        var v = null;
        ...
        var ok = false;
        var format = false;
        if (typeof color10 == "string") {
          color10 = stringInputToObject(color10);
        }
        if (typeof color10 == "object") {
          if (isValidCSSUnit(color10.r) && isValidCSSUnit(color10.g) && isValidCSSUnit(color10.b)) {
            rgb = rgbToRgb(color10.r, color10.g, color10.b);
            ok = true;
            format = String(color10.r).substr(-1) === "%" ? "prgb" : "rgb";
          } else if (isValidCSSUnit(color10.h) && isValidCSSUnit(color10.s) && isValidCSSUnit(color10.v)) {
            s = convertToPercentage(color10.s);
            v = convertToPercentage(color10.v);
            rgb = hsvToRgb(color10.h, s, v);
            ok = true;
            format = "hsv";
          } else if (isValidCSSUnit(color10.h) && isValidCSSUnit(color10.s) && isValidCSSUnit(color10.l)) {
            s = convertToPercentage(color10.s);
            l = convertToPercentage(color10.l);
            rgb = hslToRgb(color10.h, s, l);
            ok = true;
            format = "hsl";
          }
          if (color10.hasOwnProperty("a")) {
            a = color10.a;
          }
        }
        a = boundAlpha(a);
      ...
      function desaturate(color10, amount) {
        amount = amount === 0 ? 0 : amount || 10;
        var hsl = tinycolor2(color10).toHsl();
        hsl.s -= amount / 100;
        hsl.s = clamp01(hsl.s);
        return tinycolor2(hsl);
      }
      function saturate(color10, amount) {
        amount = amount === 0 ? 0 : amount || 10;
        var hsl = tinycolor2(color10).toHsl();
        hsl.s += amount / 100;
        hsl.s = clamp01(hsl.s);
      ...
      function greyscale(color10) {
        return tinycolor2(color10).desaturate(100);
      }
      function lighten(color10, amount) {
        amount = amount === 0 ? 0 : amount || 10;
        var hsl = tinycolor2(color10).toHsl();
        hsl.l += amount / 100;
        hsl.l = clamp01(hsl.l);
      ...
      function brighten(color10, amount) {
        amount = amount === 0 ? 0 : amount || 10;
        var rgb = tinycolor2(color10).toRgb();
        rgb.r = mathMax(0, mathMin(255, rgb.r - mathRound(255 * -(amount / 100))));
        rgb.g = mathMax(0, mathMin(255, rgb.g - mathRound(255 * -(amount / 100))));
        rgb.b = mathMax(0, mathMin(255, rgb.b - mathRound(255 * -(amount / 100))));
        return tinycolor2(rgb);
      }
      function darken(color10, amount) {
        amount = amount === 0 ? 0 : amount || 10;
        var hsl = tinycolor2(color10).toHsl();
        hsl.l -= amount / 100;
        hsl.l = clamp01(hsl.l);
      ...
      function spin(color10, amount) {
        var hsl = tinycolor2(color10).toHsl();
        var hue2 = (hsl.h + amount) % 360;
        hsl.h = hue2 < 0 ? 360 + hue2 : hue2;
        return tinycolor2(hsl);
      }
      function complement(color10) {
        var hsl = tinycolor2(color10).toHsl();
        hsl.h = (hsl.h + 180) % 360;
        return tinycolor2(hsl);
      }
      function triad(color10) {
        var hsl = tinycolor2(color10).toHsl();
        var h = hsl.h;
        return [
          tinycolor2(color10),
      ...
      function splitcomplement(color10) {
        var hsl = tinycolor2(color10).toHsl();
        var h = hsl.h;
        return [
          tinycolor2(color10),
      ...
      function analogous(color10, results, slices) {
        results = results || 6;
        slices = slices || 30;
        var hsl = tinycolor2(color10).toHsl();
        var part = 360 / slices;
        var ret = [tinycolor2(color10)];
      ...
      function monochromatic(color10, results) {
        results = results || 6;
        var hsv = tinycolor2(color10).toHsv();
      ...
      function isValidCSSUnit(color10) {
        return !!matchers.CSS_UNIT.exec(color10);
      }
      function stringInputToObject(color10) {
        color10 = color10.replace(trimLeft, "").replace(trimRight, "").toLowerCase();
        var named = false;
        if (names[color10]) {
          color10 = names[color10];
          named = true;
        } else if (color10 == "transparent") {
          return { r: 0, g: 0, b: 0, a: 0, format: "name" };
        }
        var match;
        if (match = matchers.rgb.exec(color10)) {
          return { r: match[1], g: match[2], b: match[3] };
        }
        if (match = matchers.rgba.exec(color10)) {
          return { r: match[1], g: match[2], b: match[3], a: match[4] };
        }
        if (match = matchers.hsl.exec(color10)) {
          return { h: match[1], s: match[2], l: match[3] };
        }
        if (match = matchers.hsla.exec(color10)) {
          return { h: match[1], s: match[2], l: match[3], a: match[4] };
        }
        if (match = matchers.hsv.exec(color10)) {
          return { h: match[1], s: match[2], v: match[3] };
        }
        if (match = matchers.hsva.exec(color10)) {
          return { h: match[1], s: match[2], v: match[3], a: match[4] };
        }
        if (match = matchers.hex8.exec(color10)) {
          return {
        ...
        if (match = matchers.hex6.exec(color10)) {
          return {
            r: parseIntFromHex(match[1]),
            g: parseIntFromHex(match[2]),
            b: parseIntFromHex(match[3]),
        ...
        if (match = matchers.hex4.exec(color10)) {
          return {
        ...
        if (match = matchers.hex3.exec(color10)) {
          return {
            r: parseIntFromHex(match[1] + "" + match[1]),
            g: parseIntFromHex(match[2] + "" + match[2]),
            b: parseIntFromHex(match[3] + "" + match[3]),
...
var import_reactcss9 = __toModule(require_lib());

// node_modules/react-color/es/components/common/Alpha.js
var import_react2 = __toModule(require_react());
var import_reactcss2 = __toModule(require_lib());
...
var import_reactcss = __toModule(require_lib());
...
var Alpha = function(_ref) {
  ...
  _createClass(Alpha2, [{
    ...
    value: function render3() {
      ...
      return import_react2.default.createElement("div", { style: styles.alpha }, import_react2.default.createElement("div", { style: styles.checkboard }, import_react2.default.createElement(Checkboard_default, { renderers: this.props.renderers })), import_react2.default.createElement("div", { style: styles.gradient }), import_react2.default.createElement("div", {
      ...
      }, import_react2.default.createElement("div", { style: styles.pointer }, this.props.pointer ? import_react2.default.createElement(this.props.pointer, this.props) : import_react2.default.createElement("div", { style: styles.slider }))));
    }
  }]);
  return Alpha2;
...
var import_reactcss3 = __toModule(require_lib());
...
var EditableInput = function(_ref) {
  ...
  _createClass2(EditableInput2, [{
    ...
    value: function render3() {
      ...
      return import_react3.default.createElement("div", { style: styles.wrap }, import_react3.default.createElement("input", {
        id: this.inputId,
        style: styles.input,
        ...
        spellCheck: "false"
      }), this.props.label && !this.props.hideLabel ? import_react3.default.createElement("label", {
...
var import_reactcss4 = __toModule(require_lib());
...
var Hue = function(_ref) {
  ...
  _createClass3(Hue2, [{
    ...
    value: function render3() {
      ...
      return import_react4.default.createElement("div", { style: styles.hue }, import_react4.default.createElement("div", {
        ...
        onTouchMove: this.handleChange,
        onTouchStart: this.handleChange
      }, import_react4.default.createElement("style", null, "\n            .hue-horizontal {\n              background: linear-gradient(to right, #f00 0%, #ff0 17%, #0f0\n                33%, #0ff 50%, #00f 67%, #f0f 83%, #f00 100%);\n              background: -webkit-linear-gradient(to right, #f00 0%, #ff0\n                17%, #0f0 33%, #0ff 50%, #00f 67%, #f0f 83%, #f00 100%);\n            }\n\n            .hue-vertical {\n              background: linear-gradient(to top, #f00 0%, #ff0 17%, #0f0 33%,\n                #0ff 50%, #00f 67%, #f0f 83%, #f00 100%);\n              background: -webkit-linear-gradient(to top, #f00 0%, #ff0 17%,\n                #0f0 33%, #0ff 50%, #00f 67%, #f0f 83%, #f00 100%);\n            }\n          "), import_react4.default.createElement("div", { style: styles.pointer }, this.props.pointer ? import_react4.default.createElement(this.props.pointer, this.props) : import_react4.default.createElement("div", { style: styles.slider }))));
    }
  }]);
  return Hue2;
...
var import_reactcss5 = __toModule(require_lib());
...
var Raised = function Raised2(_ref) {
  ...
  return import_react5.default.createElement("div", { style: styles.wrap }, import_react5.default.createElement("div", { style: styles.bg }), import_react5.default.createElement("div", { style: styles.content }, children));
};
Raised.propTypes = {
...
var import_reactcss6 = __toModule(require_lib());
...
var calculateChange5 = function calculateChange6(e, hsl, container) {
  ...
  var saturation2 = left / containerWidth;
...
var Saturation = function(_ref) {
  ...
  _createClass4(Saturation2, [{
    ...
    value: function render3() {
      var _this2 = this;
      var _ref2 = this.props.style || {}, color10 = _ref2.color, white = _ref2.white, black = _ref2.black, pointer = _ref2.pointer, circle = _ref2.circle;
      ...
      return import_react6.default.createElement("div", {
        ...
        onTouchMove: this.handleChange,
        onTouchStart: this.handleChange
      }, import_react6.default.createElement("style", null, "\n          .saturation-white {\n            background: -webkit-linear-gradient(to right, #fff, rgba(255,255,255,0));\n            background: linear-gradient(to right, #fff, rgba(255,255,255,0));\n          }\n          .saturation-black {\n            background: -webkit-linear-gradient(to top, #000, rgba(0,0,0,0));\n            background: linear-gradient(to top, #000, rgba(0,0,0,0));\n          }\n        "), import_react6.default.createElement("div", { style: styles.white, className: "saturation-white" }, import_react6.default.createElement("div", { style: styles.black, className: "saturation-black" }), import_react6.default.createElement("div", { style: styles.pointer }, this.props.pointer ? import_react6.default.createElement(this.props.pointer, this.props) : import_react6.default.createElement("div", { style: styles.circle }))));
    }
  }]);
  return Saturation2;
...
var toState = function toState2(data, oldHue) {
  var color10 = data.hex ? (0, import_tinycolor2.default)(data.hex) : (0, import_tinycolor2.default)(data);
  var hsl = color10.toHsl();
  var hsv = color10.toHsv();
  var rgb = color10.toRgb();
  var hex = color10.toHex();
  if (hsl.s === 0) {
    hsl.h = oldHue || 0;
    hsv.h = oldHue || 0;
  }
...
var import_reactcss7 = __toModule(require_lib());
...
var handleFocus = function handleFocus2(Component6) {
  ...
  return function(_React$Component) {
    ...
    _createClass6(Focus, [{
      key: "render",
      value: function render3() {
        return import_react8.default.createElement(Span, { onFocus: this.handleFocus, onBlur: this.handleBlur }, import_react8.default.createElement(Component6, _extends4({}, this.props, this.state)));
      }
    }]);
    return Focus;
...
var Swatch = function Swatch2(_ref) {
  var color10 = _ref.color, style = _ref.style, _ref$onClick = _ref.onClick, onClick = _ref$onClick === void 0 ? function() {
  } : _ref$onClick, onHover = _ref.onHover, _ref$title = _ref.title, title = _ref$title === void 0 ? color10 : _ref$title, children = _ref.children, focus = _ref.focus, _ref$focusStyle = _ref.focusStyle, focusStyle = _ref$focusStyle === void 0 ? {} : _ref$focusStyle;
  var transparent = color10 === "transparent";
  ...
  var handleClick = function handleClick2(e) {
    return onClick(color10, e);
  };
  var handleKeyDown = function handleKeyDown2(e) {
    return e.keyCode === ENTER && onClick(color10, e);
  };
  var handleHover3 = function handleHover4(e) {
    return onHover(color10, e);
  };
  var optionalEvents = {};
  if (onHover) {
  ...
  }, optionalEvents), children, transparent && import_react9.default.createElement(Checkboard_default, {
...
var import_reactcss8 = __toModule(require_lib());
...
var AlphaPicker = function AlphaPicker2(_ref) {
  ...
  return import_react11.default.createElement("div", { style: styles.picker, className: "alpha-picker " + className }, import_react11.default.createElement(Alpha_default, _extends6({}, styles.alpha, {
    rgb,
    hsl,
    pointer,
    renderers,
...
var import_reactcss11 = __toModule(require_lib());

// node_modules/react-color/es/components/block/BlockSwatches.js
var import_react12 = __toModule(require_react());
var import_reactcss10 = __toModule(require_lib());
...
var BlockSwatches = function BlockSwatches2(_ref) {
  ...
  return import_react12.default.createElement("div", { style: styles.swatches }, map_default(colors, function(c) {
...
var Block = function Block2(_ref) {
  ...
  return import_react13.default.createElement("div", { style: styles.card, className: "block-picker " + className }, import_react13.default.createElement("div", { style: styles.triangle }), import_react13.default.createElement("div", { style: styles.head }, transparent && import_react13.default.createElement(Checkboard_default, { borderRadius: "6px 6px 0 0" }), import_react13.default.createElement("div", { style: styles.label }, hex)), import_react13.default.createElement("div", { style: styles.body }, import_react13.default.createElement(BlockSwatches_default, { colors, onClick: handleChange, onSwatchHover }), import_react13.default.createElement(EditableInput_default, {
...
var import_reactcss13 = __toModule(require_lib());
...
var import_reactcss12 = __toModule(require_lib());
var CircleSwatch = function CircleSwatch2(_ref) {
  var color10 = _ref.color, onClick = _ref.onClick, onSwatchHover = _ref.onSwatchHover, hover = _ref.hover, active = _ref.active, circleSize = _ref.circleSize, circleSpacing = _ref.circleSpacing;
  var styles = (0, import_reactcss12.default)({
    "default": {
      ...
      Swatch: {
        ...
        boxShadow: "inset 0 0 0 " + (circleSize / 2 + 1) + "px " + color10,
    ...
    "active": {
      Swatch: {
        boxShadow: "inset 0 0 0 3px " + color10
      }
    }
  }, { hover, active });
  return import_react14.default.createElement("div", { style: styles.swatch }, import_react14.default.createElement(Swatch_default, {
    style: styles.Swatch,
    color: color10,
    onClick,
    onHover: onSwatchHover,
    focusStyle: { boxShadow: styles.Swatch.boxShadow + ", 0 0 5px " + color10 }
  }));
};
...
var Circle = function Circle2(_ref) {
  ...
  return import_react15.default.createElement("div", { style: styles.card, className: "circle-picker " + className }, map_default(colors, function(c) {
...
var import_reactcss17 = __toModule(require_lib());

// node_modules/react-color/es/components/chrome/ChromeFields.js
var import_react16 = __toModule(require_react());
var import_reactcss14 = __toModule(require_lib());
...
// node_modules/react-color/es/components/chrome/ChromeFields.js
var import_UnfoldMoreHorizontalIcon = __toModule(require_UnfoldMoreHorizontalIcon());
  ...
  _createClass7(ChromeFields2, [{
    ...
    value: function render3() {
      ...
      if (this.state.view === "hex") {
        fields = import_react16.default.createElement("div", { style: styles.fields, className: "flexbox-fix" }, import_react16.default.createElement("div", { style: styles.field }, import_react16.default.createElement(EditableInput_default, {
        ...
        fields = import_react16.default.createElement("div", { style: styles.fields, className: "flexbox-fix" }, import_react16.default.createElement("div", { style: styles.field }, import_react16.default.createElement(EditableInput_default, {
          ...
          onChange: this.handleChange
        })), import_react16.default.createElement("div", { style: styles.field }, import_react16.default.createElement(EditableInput_default, {
          style: { input: styles.input, label: styles.label },
          label: "g",
          ...
          onChange: this.handleChange
        })), import_react16.default.createElement("div", { style: styles.alpha }, import_react16.default.createElement(EditableInput_default, {
          style: { input: styles.input, label: styles.label },
          label: "a",
      ...
      return import_react16.default.createElement("div", { style: styles.wrap, className: "flexbox-fix" }, fields, import_react16.default.createElement("div", { style: styles.toggle }, import_react16.default.createElement("div", { style: styles.icon, onClick: this.toggleViews, ref: function ref(icon) {
...
var import_reactcss15 = __toModule(require_lib());
...
var import_reactcss16 = __toModule(require_lib());
...
var Chrome = function Chrome2(_ref) {
  ...
  return import_react19.default.createElement("div", { style: styles.picker, className: "chrome-picker " + className }, import_react19.default.createElement("div", { style: styles.saturation }, import_react19.default.createElement(Saturation_default, {
    style: styles.Saturation,
    hsl,
    hsv,
    pointer: ChromePointerCircle_default,
    onChange
  })), import_react19.default.createElement("div", { style: styles.body }, import_react19.default.createElement("div", { style: styles.controls, className: "flexbox-fix" }, import_react19.default.createElement("div", { style: styles.color }, import_react19.default.createElement("div", { style: styles.swatch }, import_react19.default.createElement("div", { style: styles.active }), import_react19.default.createElement(Checkboard_default, { renderers }))), import_react19.default.createElement("div", { style: styles.toggles }, import_react19.default.createElement("div", { style: styles.hue }, import_react19.default.createElement(Hue_default, {
    style: styles.Hue,
    hsl,
    pointer: ChromePointer_default,
    onChange
  })), import_react19.default.createElement("div", { style: styles.alpha }, import_react19.default.createElement(Alpha_default, {
    style: styles.Alpha,
    rgb,
    hsl,
    pointer: ChromePointer_default,
...
var import_reactcss20 = __toModule(require_lib());

// node_modules/react-color/es/components/compact/CompactColor.js
var import_react20 = __toModule(require_react());
var import_reactcss18 = __toModule(require_lib());
var CompactColor = function CompactColor2(_ref) {
  var color10 = _ref.color, _ref$onClick = _ref.onClick, onClick = _ref$onClick === void 0 ? function() {
  ...
  var styles = (0, import_reactcss18.default)({
    "default": {
      ...
      dot: {
        ...
        background: getContrastingColor(color10),
        borderRadius: "50%",
        opacity: "0"
      }
    },
  ...
  }, { active, "color-#FFFFFF": color10 === "#FFFFFF", "transparent": color10 === "transparent" });
  return import_react20.default.createElement(Swatch_default, {
    style: styles.color,
    color: color10,
    onClick,
    onHover: onSwatchHover,
    focusStyle: { boxShadow: "0 0 4px " + color10 }
...
var import_reactcss19 = __toModule(require_lib());
var CompactFields = function CompactFields2(_ref) {
  ...
  return import_react21.default.createElement("div", { style: styles.fields, className: "flexbox-fix" }, import_react21.default.createElement("div", { style: styles.active }), import_react21.default.createElement(EditableInput_default, {
...
var Compact = function Compact2(_ref) {
  ...
  return import_react22.default.createElement(Raised_default, { style: styles.Compact, styles: passedStyles }, import_react22.default.createElement("div", { style: styles.compact, className: "compact-picker " + className }, import_react22.default.createElement("div", null, map_default(colors, function(c) {
  ...
  }), import_react22.default.createElement("div", { style: styles.clear })), import_react22.default.createElement(CompactFields_default, { hex, rgb, onChange: handleChange })));
};
Compact.propTypes = {
...
var import_reactcss22 = __toModule(require_lib());

// node_modules/react-color/es/components/github/GithubSwatch.js
var import_react23 = __toModule(require_react());
var import_reactcss21 = __toModule(require_lib());
var GithubSwatch = function GithubSwatch2(_ref) {
  var hover = _ref.hover, color10 = _ref.color, onClick = _ref.onClick, onSwatchHover = _ref.onSwatchHover;
  var hoverSwatch = {
    position: "relative",
    zIndex: "2",
  ...
  return import_react23.default.createElement("div", { style: styles.swatch }, import_react23.default.createElement(Swatch_default, {
    color: color10,
    onClick,
    onHover: onSwatchHover,
...
var Github = function Github2(_ref) {
  ...
  return import_react24.default.createElement("div", { style: styles.card, className: "github-picker " + className }, import_react24.default.createElement("div", { style: styles.triangleShadow }), import_react24.default.createElement("div", { style: styles.triangle }), map_default(colors, function(c) {
...
var import_reactcss24 = __toModule(require_lib());

// node_modules/react-color/es/components/hue/HuePointer.js
var import_react25 = __toModule(require_react());
var import_reactcss23 = __toModule(require_lib());
...
var HuePicker = function HuePicker2(_ref) {
  ...
  return import_react26.default.createElement("div", { style: styles.picker, className: "hue-picker " + className }, import_react26.default.createElement(Hue_default, _extends7({}, styles.hue, {
    hsl,
    pointer,
    onChange: handleChange,
    direction
...
var import_reactcss25 = __toModule(require_lib());
var Material = function Material2(_ref) {
  ...
  return import_react27.default.createElement(Raised_default, { styles: passedStyles }, import_react27.default.createElement("div", { style: styles.material, className: "material-picker " + className }, import_react27.default.createElement(EditableInput_default, {
    style: { wrap: styles.HEXwrap, input: styles.HEXinput, label: styles.HEXlabel },
    label: "hex",
    value: hex,
    onChange: handleChange
  }), import_react27.default.createElement("div", { style: styles.split, className: "flexbox-fix" }, import_react27.default.createElement("div", { style: styles.third }, import_react27.default.createElement(EditableInput_default, {
    style: { wrap: styles.RGBwrap, input: styles.RGBinput, label: styles.RGBlabel },
    label: "r",
    value: rgb.r,
    onChange: handleChange
  })), import_react27.default.createElement("div", { style: styles.third }, import_react27.default.createElement(EditableInput_default, {
    style: { wrap: styles.RGBwrap, input: styles.RGBinput, label: styles.RGBlabel },
    label: "g",
    value: rgb.g,
    onChange: handleChange
...
var import_reactcss31 = __toModule(require_lib());

// node_modules/react-color/es/components/photoshop/PhotoshopFields.js
var import_react28 = __toModule(require_react());
var import_reactcss26 = __toModule(require_lib());
var PhotoshopPicker = function PhotoshopPicker2(_ref) {
  ...
  return import_react28.default.createElement("div", { style: styles.fields }, import_react28.default.createElement(EditableInput_default, {
    style: { wrap: styles.RGBwrap, input: styles.RGBinput, label: styles.RGBlabel },
    label: "h",
    ...
    onChange: handleChange
  }), import_react28.default.createElement("div", { style: styles.divider }), import_react28.default.createElement(EditableInput_default, {
    style: { wrap: styles.RGBwrap, input: styles.RGBinput, label: styles.RGBlabel },
    label: "r",
    value: rgb.r,
    onChange: handleChange
    ...
    value: hex.replace("#", ""),
    onChange: handleChange
  }), import_react28.default.createElement("div", { style: styles.fieldSymbols }, import_react28.default.createElement("div", { style: styles.symbol }, "\xB0"), import_react28.default.createElement("div", { style: styles.symbol }, "%"), import_react28.default.createElement("div", { style: styles.symbol }, "%")));
};
...
var import_reactcss27 = __toModule(require_lib());
...
var import_reactcss28 = __toModule(require_lib());
var PhotoshopPointerCircle3 = function PhotoshopPointerCircle4() {
  ...
  return import_react30.default.createElement("div", { style: styles.pointer }, import_react30.default.createElement("div", { style: styles.left }, import_react30.default.createElement("div", { style: styles.leftInside })), import_react30.default.createElement("div", { style: styles.right }, import_react30.default.createElement("div", { style: styles.rightInside })));
};
...
var import_reactcss29 = __toModule(require_lib());
var PhotoshopButton = function PhotoshopButton2(_ref) {
  ...
  return import_react31.default.createElement("div", { style: styles.button, onClick }, label || children);
};
...
var import_reactcss30 = __toModule(require_lib());
var PhotoshopPreviews = function PhotoshopPreviews2(_ref) {
  ...
  return import_react32.default.createElement("div", null, import_react32.default.createElement("div", { style: styles.label }, "new"), import_react32.default.createElement("div", { style: styles.swatches }, import_react32.default.createElement("div", { style: styles.new }), import_react32.default.createElement("div", { style: styles.current })), import_react32.default.createElement("div", { style: styles.label }, "current"));
};
...
var Photoshop = function(_React$Component) {
  ...
  _createClass8(Photoshop2, [{
    ...
    value: function render3() {
      ...
      return import_react33.default.createElement("div", { style: styles.picker, className: "photoshop-picker " + className }, import_react33.default.createElement("div", { style: styles.head }, this.props.header), import_react33.default.createElement("div", { style: styles.body, className: "flexbox-fix" }, import_react33.default.createElement("div", { style: styles.saturation }, import_react33.default.createElement(Saturation_default, {
        hsl: this.props.hsl,
        hsv: this.props.hsv,
        pointer: PhotoshopPointerCircle_default,
        onChange: this.props.onChange
      })), import_react33.default.createElement("div", { style: styles.hue }, import_react33.default.createElement(Hue_default, {
        direction: "vertical",
        hsl: this.props.hsl,
        pointer: PhotoshopPointer_default,
        onChange: this.props.onChange
      })), import_react33.default.createElement("div", { style: styles.controls }, import_react33.default.createElement("div", { style: styles.top, className: "flexbox-fix" }, import_react33.default.createElement("div", { style: styles.previews }, import_react33.default.createElement(PhotoshopPreviews_default, {
        rgb: this.props.rgb,
        currentColor: this.state.currentColor
      })), import_react33.default.createElement("div", { style: styles.actions }, import_react33.default.createElement(PhotoshopButton_default, { label: "OK", onClick: this.props.onAccept, active: true }), import_react33.default.createElement(PhotoshopButton_default, { label: "Cancel", onClick: this.props.onCancel }), import_react33.default.createElement(PhotoshopFields_default, {
        onChange: this.props.onChange,
        rgb: this.props.rgb,
        hsv: this.props.hsv,
        hex: this.props.hex
...
var SketchFields = function SketchFields2(_ref) {
  ...
  return import_react34.default.createElement("div", { style: styles.fields, className: "flexbox-fix" }, import_react34.default.createElement("div", { style: styles.double }, import_react34.default.createElement(EditableInput_default, {
    style: { input: styles.input, label: styles.label },
    label: "hex",
    value: hex.replace("#", ""),
    onChange: handleChange
  })), import_react34.default.createElement("div", { style: styles.single }, import_react34.default.createElement(EditableInput_default, {
    style: { input: styles.input, label: styles.label },
    label: "r",
    value: rgb.r,
    onChange: handleChange,
    ...
    dragLabel: "true",
    dragMax: "255"
  })), import_react34.default.createElement("div", { style: styles.alpha }, import_react34.default.createElement(EditableInput_default, {
    style: { input: styles.input, label: styles.label },
    label: "a",
...
var import_reactcss33 = __toModule(require_lib());
...
var SketchPresetColors = function SketchPresetColors2(_ref) {
  ...
  return import_react35.default.createElement("div", { style: styles.colors, className: "flexbox-fix" }, colors.map(function(colorObjOrString) {
    var c = typeof colorObjOrString === "string" ? { color: colorObjOrString } : colorObjOrString;
    var key = "" + c.color + (c.title || "");
    return import_react35.default.createElement("div", { key, style: styles.swatchWrap }, import_react35.default.createElement(Swatch_default, _extends8({}, c, {
      style: styles.swatch,
      onClick: handleClick,
      onHover: onSwatchHover,
      focusStyle: {
...
var Sketch = function Sketch2(_ref) {
  ...
  return import_react36.default.createElement("div", { style: styles.picker, className: "sketch-picker " + className }, import_react36.default.createElement("div", { style: styles.saturation }, import_react36.default.createElement(Saturation_default, {
    style: styles.Saturation,
    hsl,
    hsv,
    onChange
  })), import_react36.default.createElement("div", { style: styles.controls, className: "flexbox-fix" }, import_react36.default.createElement("div", { style: styles.sliders }, import_react36.default.createElement("div", { style: styles.hue }, import_react36.default.createElement(Hue_default, {
    style: styles.Hue,
    hsl,
    onChange
  })), import_react36.default.createElement("div", { style: styles.alpha }, import_react36.default.createElement(Alpha_default, {
    style: styles.Alpha,
    rgb,
    hsl,
    renderers,
    onChange
  }))), import_react36.default.createElement("div", { style: styles.color }, import_react36.default.createElement(Checkboard_default, null), import_react36.default.createElement("div", { style: styles.activeColor }))), import_react36.default.createElement(SketchFields_default, {
    rgb,
    hsl,
    hex,
    onChange,
...
var SliderSwatches = function SliderSwatches2(_ref) {
  ...
  var epsilon = 0.1;
  return import_react38.default.createElement("div", { style: styles.swatches }, import_react38.default.createElement("div", { style: styles.swatch }, import_react38.default.createElement(SliderSwatch_default, {
    hsl,
    offset: ".80",
    active: Math.abs(hsl.l - 0.8) < epsilon && Math.abs(hsl.s - 0.5) < epsilon,
    onClick,
    first: true
  })), import_react38.default.createElement("div", { style: styles.swatch }, import_react38.default.createElement(SliderSwatch_default, {
    hsl,
    offset: ".65",
...
var import_reactcss37 = __toModule(require_lib());
...
var Slider = function Slider2(_ref) {
  ...
  return import_react40.default.createElement("div", { style: styles.wrap || {}, className: "slider-picker " + className }, import_react40.default.createElement("div", { style: styles.hue }, import_react40.default.createElement(Hue_default, {
    style: styles.Hue,
    hsl,
    pointer,
    onChange
  })), import_react40.default.createElement("div", { style: styles.swatches }, import_react40.default.createElement(SliderSwatches_default, { hsl, onClick: onChange })));
};
Slider.propTypes = {
...
var SwatchesColor = function SwatchesColor2(_ref) {
  ...
  var styles = (0, import_reactcss39.default)({
    "default": {
      ...
      check: {
        color: getContrastingColor(color10),
        marginLeft: "8px",
        display: "none"
      }
    },
    ...
    last,
    active,
    "color-#FFFFFF": color10 === "#FFFFFF",
    "transparent": color10 === "transparent"
  });
  return import_react41.default.createElement(Swatch_default, {
    color: color10,
    style: styles.color,
    onClick,
    onHover: onSwatchHover,
    focusStyle: { boxShadow: "0 0 4px " + color10 }
  }, import_react41.default.createElement("div", { style: styles.check }, import_react41.default.createElement(import_CheckIcon.default, null)));
};
...
var SwatchesGroup = function SwatchesGroup2(_ref) {
  ...
  return import_react42.default.createElement("div", { style: styles.group }, map_default(group, function(color10, i) {
    return import_react42.default.createElement(SwatchesColor_default, {
      key: color10,
      color: color10,
      active: color10.toLowerCase() === active,
      first: i === 0,
...
var Swatches = function Swatches2(_ref) {
  ...
  return import_react43.default.createElement("div", { style: styles.picker, className: "swatches-picker " + className }, import_react43.default.createElement(Raised_default, null, import_react43.default.createElement("div", { style: styles.overflow }, import_react43.default.createElement("div", { style: styles.body }, map_default(colors, function(group) {
...
var import_reactcss42 = __toModule(require_lib());
var Twitter = function Twitter2(_ref) {
  ...
  return import_react44.default.createElement("div", { style: styles.card, className: "twitter-picker " + className }, import_react44.default.createElement("div", { style: styles.triangleShadow }), import_react44.default.createElement("div", { style: styles.triangle }), import_react44.default.createElement("div", { style: styles.body }, map_default(colors, function(c, i) {
  ...
  }), import_react44.default.createElement("div", { style: styles.hash }, "#"), import_react44.default.createElement(EditableInput_default, {
    label: null,
    style: { input: styles.input },
    value: hex.replace("#", ""),
    onChange: handleChange
...
var import_reactcss44 = __toModule(require_lib());
...
var import_reactcss45 = __toModule(require_lib());
var GoogleFields = function GoogleFields2(_ref) {
  ...
  return import_react47.default.createElement("div", { style: styles.wrap, className: "flexbox-fix" }, import_react47.default.createElement("div", { style: styles.fields }, import_react47.default.createElement("div", { style: styles.double }, import_react47.default.createElement(EditableInput_default, {
    style: { input: styles.input, label: styles.label },
    label: "hex",
    value: hex,
    onChange: handleChange
  })), import_react47.default.createElement("div", { style: styles.column }, import_react47.default.createElement("div", { style: styles.single }, import_react47.default.createElement(EditableInput_default, {
    style: { input: styles.input2, label: styles.label2 },
    label: "rgb",
    value: rgbValue,
    onChange: handleChange
  })), import_react47.default.createElement("div", { style: styles.single }, import_react47.default.createElement(EditableInput_default, {
    style: { input: styles.input2, label: styles.label2 },
    label: "hsv",
    value: hsvValue,
    onChange: handleChange
...
var Google = function Google2(_ref) {
  ...
  return import_react48.default.createElement("div", { style: styles.picker, className: "google-picker " + className }, import_react48.default.createElement("div", { style: styles.head }, header), import_react48.default.createElement("div", { style: styles.swatch }), import_react48.default.createElement("div", { style: styles.saturation }, import_react48.default.createElement(Saturation_default, {
    hsl,
    hsv,
    pointer: GooglePointerCircle_default,
    onChange
  })), import_react48.default.createElement("div", { style: styles.body }, import_react48.default.createElement("div", { style: styles.controls, className: "flexbox-fix" }, import_react48.default.createElement("div", { style: styles.hue }, import_react48.default.createElement(Hue_default, {
    style: styles.Hue,
    hsl,
    radius: "4px",
...
// dep:react-color
var react_color_default = Chrome_default;
export {
  ...
  react_color_default as default
};
